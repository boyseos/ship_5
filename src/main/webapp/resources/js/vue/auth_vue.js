...
auth_vue = (()=>{
	return{
		...
		''+        '<div class="mb-3">'+
		'          <label for="address2">중복체크<span class="text-muted">(Optional)</span></label>'+
		'          <input type="text" class="form-control" id="dupl_check" placeholder="Apartment or suite">'+
		'        </div>'+
